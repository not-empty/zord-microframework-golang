...
func NewDummyRoutes(logger *logger.Logger, mysql *database.MySql, idCreator *idCreator.IdCreator, validator *validator.Validator, Environment string) *DummyRoutes {
