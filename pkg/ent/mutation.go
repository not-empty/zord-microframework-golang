...
func (m *CartMutation) SetModifiedAt(t time.Time) {
	m._ModifiedAt = &t
}

// ModifiedAt returns the value of the "ModifiedAt" field in the mutation.
func (m *CartMutation) ModifiedAt() (r time.Time, exists bool) {
	v := m._ModifiedAt
	if v == nil {
		return
	}
...
// OldModifiedAt returns the old "ModifiedAt" field's value of the Cart entity.
// If the Cart object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CartMutation) OldModifiedAt(ctx context.Context) (v time.Time, err error) {
...
func (m *CartMutation) ResetModifiedAt() {
	m._ModifiedAt = nil
}
...
func (m *CartMutation) Fields() []string {
	...
	if m._ModifiedAt != nil {
		fields = append(fields, cart.FieldModifiedAt)
	}
	return fields
}
...
func (m *UserMutation) AddCartIDs(ids ...string) {
	if m.cart == nil {
		m.cart = make(map[string]struct{})
	}
	for i := range ids {
		m.cart[ids[i]] = struct{}{}
	}
...
func (m *UserMutation) RemoveCartIDs(ids ...string) {
	if m.removedcart == nil {
		m.removedcart = make(map[string]struct{})
	}
	for i := range ids {
		delete(m.cart, ids[i])
...
func (m *UserMutation) RemovedCartIDs() (ids []string) {
